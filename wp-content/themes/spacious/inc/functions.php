...
function spacious_footer_copyright() {
	...
	$marjori_link = '<a href="'.esc_url( 'http://marjoritamise.com.br' ).'" target="_blank" alt="Márjori Tamise"></a>';

	$default_footer_value = sprintf( __( 'Copyright &copy; %1$s %2$s.', 'spacious' ), date( 'Y' ), $site_link ).' '.sprintf( __( 'Desenvolvido por <a href="http://marjoritamise.com.br" target="_blank">Márjori Tamise</a> %s.' ), $marjori_link );
